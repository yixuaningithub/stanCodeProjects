...
def get_best_pixel(pixels):
    ...
    # # print(type(pixels[pixel_num]))
    # return pixels[pixel_num]
    return min(list((get_pixel_dist(pixel, *get_average(pixels)), pixel) for pixel in pixels), key=lambda t: t[0])[1]
...
def solve(images):
    ...
    for x in range(width):
        for y in range(height):
            ...
            pixel_im = [image.get_pixel(x, y) for image in images]
            ...
            result.set_pixel(x, y, pixel_best)
    # ----- YOUR CODE ENDS HERE ----- #
